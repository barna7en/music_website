...
-- Lemonade выпущен Beyoncé так же как
...
-- Revival выпущен группой Queen в 2019г
INSERT INTO album_artists (album_id, artist_id) VALUES ((SELECT album_id FROM albums WHERE album_title='Revival'), (SELECT artist_id FROM artists WHERE artist_name='Queen'));
...
('My Way', '00:03:45', (SELECT album_id FROM albums WHERE album_title='Back in Black')),
